...
class WorkersControllerTest < ActionController::TestCase
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post :create, worker: { email: @worker.email, full_name: @worker.full_name, is_worker: @worker.is_worker }
    end
  ...
  test "should update worker" do
    put :update, id: @worker, worker: { email: @worker.email, full_name: @worker.full_name, is_worker: @worker.is_worker }
    assert_redirected_to worker_path(assigns(:worker))
  end
